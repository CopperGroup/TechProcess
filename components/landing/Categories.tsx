...
const categories = [
  { name: "Кольє", image: "/assets/1.jpg", href: "/catalog" },
  { name: "Кільця", image: "/assets/2.jpg", href: "/catalog" },
  { name: "Браслети", image: "/assets/3.jpg", href: "/catalog" },
]
      ...
      <div className="w-full max-w-[1680px] flex flex-col items-center px-4 sm:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-[#E5E5E5] text-body-medium max-w-2xl mx-auto leading-relaxed">
            Досліджуйте нашу вишукану колекцію розкішних виробів, де вічна елегантність поєднується із сучасним дизайном. 
            Кожна категорія пропонує унікальний досвід розкоші та майстерності.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <Link href="/catalog">ПЕРЕГЛЯНУТИ ВСІ КАТЕГОРІЇ</Link>
          </Button>
        </motion.div>
      </div>
    </motion.section>
